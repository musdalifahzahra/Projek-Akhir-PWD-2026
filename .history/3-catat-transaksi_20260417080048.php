...
if (isset($_POST["submit"])) {
    ...
    //cek data berhasil di tambahkan apa ngga, 1=berhasil, -1=ga berhasil
        ...
        <div class="input-transaksi template">
            <form class="row g-3" method="POST">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" requiredd>
                </div>
                <!-- keterangan -->
                <div class="col-md-3">
