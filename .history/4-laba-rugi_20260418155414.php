    ...
    <div class="wrap">
        ...
        <div class="laporan-laba-rugi card">
            ...
            <div class="laporan-biaya">
                ...
                <?php if ($BIA_penjualan > 0) { ?>
                    <div class="baris-laporan">
                        <span>Penjualan</span>
                        <span><?= "Rp. " . $BIA_penjualan; ?></span>
                    </div>
                <?php } ?>

                <?php if ($BIA_belanja_stok > 0) { ?>
                    <div class="baris-laporan">
                        <span>Belanja Stok</span>
                        <span><?= "Rp. " . $BIA_belanja_stok; ?></span>
                    </div>
                <?php } ?>

                <?php if ($BIA_operasional > 0) { ?>
                    <div class="baris-laporan">
                        <span>Operasional</span>
                        <span><?= "Rp. " . $BIA_operasional; ?></span>
                    </div>
                <?php } ?>
                ...
                <?php if ($BIA_gaji > 0) { ?>
                    <div class="baris-laporan">
                        <span>Gaji</span>
                        <span><?= "Rp. " . $BIA_gaji; ?></span>
                    </div>
                <?php } ?>

                <?php if ($BIA_lain_lain > 0) { ?>
                    <div class="baris-laporan">
                        <span>Lain_lain</span>
                        <span><?= "Rp. " . $BIA_lain_lain; ?></span>
                    </div>
                <?php } ?>

                <div class="baris-laporan-footer">
                    <span>Total BIA</span>
                    <span><?= "Rp. " . $total_BIA ?></span>
                </div>
