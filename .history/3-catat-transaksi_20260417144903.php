                ...
                <?php foreach ($transaksi_terbaru as $data) : ?>
                    <div class="satu-transaksi">
                        ...
                        <div class="b">
                            ...
                            <!-- Button modal ubah -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-ubah<?= $data ?>">
                                Ubah
                            </button>
                            <!-- MODAL POP UP UBAH -->
                            <!-- Modal -->
                            <div class="modal fade" id="modal-ubah<?= $data ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
