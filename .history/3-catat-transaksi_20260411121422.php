...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO transaksi
              VALUES ('', '$tanggal', '$keterangan', '$kategori', '$jenis', '$jumlah', '$catatan')
              ";
        ...
        <div class="input-transaksi template">
            <form class="row g-3" method="POST">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" requai>
                </div>
                <!-- keterangan -->
                <div class="col-md-3">
                    <label for="keterangan" class="form-label">Keterangan</label>
                    <input type="text" class="form-control" id="keterangan" name="keterangan" requai>
                </div>
                <!-- kategori -->
                <div class="col-md-3">
                    <label for="inputZip" class="form-label">Kategori</label>
                    <select class="form-select" id="kategori" aria-label="Default select example" name="kategori" requai>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="jenis" aria-label="Default select example" name="jenis" requai>
                        <option selected>Jenis</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" requai>
                </div>
                <!-- catatan -->
                <div class="col-md-7">
                ...
                <div class="col-md-2 d-flex align-items-end justify-content-end">
                    <button type="submit" class="btn btn-primary" id="catat" name="submit" requai> +Catat </button>
                </div>
            </form>
        </div>
