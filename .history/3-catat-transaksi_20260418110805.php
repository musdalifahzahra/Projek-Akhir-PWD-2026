                ...
                <?php foreach ($transaksi_terbaru as $data) : ?>
                    <div class="satu-transaksi">
                        ...
                        <div class="b">
                            ...
                            <!-- hapus -->
                            <a class="hapus" href="0-hapus.php?id=<?= $data["No"] ?>" onclick="return confirm('Apakah anda ingin mengapus data tersebut');"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
