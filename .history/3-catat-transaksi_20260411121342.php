        ...
        <div class="input-transaksi template">
            <form class="row g-3" method="POST">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" r>
                </div>
                <!-- keterangan -->
                <div class="col-md-3">
                    <label for="keterangan" class="form-label">Keterangan</label>
                    <input type="text" class="form-control" id="keterangan" name="keterangan" r>
                </div>
                <!-- kategori -->
                <div class="col-md-3">
                    <label for="inputZip" class="form-label">Kategori</label>
                    <select class="form-select" id="kategori" aria-label="Default select example" name="kategori" r>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="jenis" aria-label="Default select example" name="jenis" r>
                        <option selected>Jenis</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" r>
                </div>
                <!-- catatan -->
                <div class="col-md-7">
