...
<body>
    ...
    <div class="wrap">
        ...
        // manggil fungsi transaksi sambil emmbawa parameter yg berfungsi u/ ngambil nya 
         $transaksi_terbaru = transaksi("SELECT * FROM transaksi ORDER BY No DESC LIMIT 6");
         ?>
        ...
        <?php $select = mysqli_query($conn, "SELECT * FROM transaksi ORDER BY No DESC LIMIT 6") ?>
        <div class="tampil-transaksi-terbaru template">
            <h5>Transaksi Terbaru</h5><br>
            <div class="wrap-transaksi">
                <!-- mysqli_fetch_array = ambil satu baris dari $select -->
