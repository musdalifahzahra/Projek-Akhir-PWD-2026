...
foreach ($rows as $data) {
    if ($data["Jenis"] == "Pemasukan") {
        ...
        else if(["Kategori"] == "Operasional"){$pendapatan_belanja_stok += $data["Jumlah"];}
        else if(["Kategori"] == "Penjualan"){$pendapatan_belanja_stok += $data["Jumlah"];}
        else if(["Kategori"] == "Gaji"){$pendapatan_belanja_stok += $data["Jumlah"];}
    } else {
        $biaya[] = $data;
