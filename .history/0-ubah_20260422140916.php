                        ...
                        <form class="row g-3" action="0-koneksi.php" method="POST">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="kategori" aria-label="Default select example" name="kategori" required>
                                    ...
                                    <option value="Penjualan" <?= ($data['Penjualan'] == "Penjualan") ? 'selected' : '' ?>>Penjualan</option>
                                    <option value="Belanja Stok" <?= ($data['Belanja Stok'] == "Belanja Stok") ? 'selected' : '' ?>>Belanja Stok</option>
                                    <option value="Operasional" <?= ($data['Operasional'] == "Operasional") ? 'selected' : '' ?>>Operasional</option>
