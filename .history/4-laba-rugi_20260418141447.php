    ...
    <div class="wrap">
        ...
        <div class="laporan-laba-rugi card">
            ...
            <div class="laporan-pendapatan">
                <div class="baris-laporan-header"><p>PENDAPATAN</p></div>
                <div class="baris-laporan"><p>Penjualan</p><p></p></div>
                <div class="baris-laporan"></div>
                <div class="baris-laporan"></div>
            </div>
            <div class="laporan-biaya">
                <div class="baris-laporan-header"><P>BIAYA OPERASIONAL</P></div>
                <div class="baris-laporan"></div>
                <div class="baris-laporan"></div>
                <div class="baris-laporan"></div>
                <div class="baris-laporan"></div>
            ...
            <div class="laporan-laba-bersih">
                <div class="baris-laporan-header"><P>LABA BERSIH</P></div>
            </div>
        </div>
    </div>
</body>
