...
foreach ($rows as $data) {
    if ($data["Jenis"] == "Pemasukan") {
        ...
        if($data["Kategori"] == "Belanja Stok"){$biaya
            _belanja_stok += $data["Jumlah"];}
        else if(["Kategori"] == "Operasional"){$biaya
            _operasional += $data["Jumlah"];}
        else if(["Kategori"] == "Penjualan"){$biaya
            _penjualan += $data["Jumlah"];}
        else if(["Kategori"] == "Gaji"){$biaya
            _gaji += $data["Jumlah"];}
        else if(["Kategori"] == "Gaji"){$biaya
            _gaji += $data["Jumlah"];}
        else if(["Kategori"] == "Lain-lain"){$biaya
            _lain_lain += $data["Jumlah"];}
    }
}
