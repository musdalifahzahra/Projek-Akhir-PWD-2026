...
foreach ($rows as $data) {
    if ($data["Jenis"] == "Pemasukan") {
        ...
        if($data["Kategori"] == "Belanja Stok"){$pendapatan_ += $data["Jumlah"];}
        else if(["Kategori"] == "Operasional"){$pendapatan_ += $data["Jumlah"];}
        else if(["Kategori"] == "Penjualan"){$pendapatan_ += $data["Jumlah"];}
        else if(["Kategori"] == "Gaji"){$pendapatan_ += $data["Jumlah"];}
    } else {
        $biaya[] = $data;
