            ...
            <form class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="kategori" aria-label="Default select example">
                        ...
                        <option value="Pemasukan">Penjualan</option>
                        <option value="Pengeluaran">Belanja Stok</option>
                        <option value="Pengeluaran">Operasional</option>
                        <option value="Pengeluaran">Gaji</option>
                        <option value="Pengeluaran">Lain-lain</option>
                        <option value="Pengeluaran">Belanja Stok</option>
                    </select>
                </div>
                <!-- jenis -->
