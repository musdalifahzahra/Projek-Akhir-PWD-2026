        ...
        <div class="input-transaksi template">
            <form class="row g-3" method="POST">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" req>
                </div>
                <!-- keterangan -->
                <div class="col-md-3">
                    <label for="keterangan" class="form-label">Keterangan</label>
                    <input type="text" class="form-control" id="keterangan" name="keterangan" req>
                </div>
                <!-- kategori -->
                <div class="col-md-3">
                    <label for="inputZip" class="form-label">Kategori</label>
                    <select class="form-select" id="kategori" aria-label="Default select example" name="kategori" req>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="jenis" aria-label="Default select example" name="jenis" req>
                        <option selected>Jenis</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" req>
                </div>
                <!-- catatan -->
                <div class="col-md-7">
                ...
                <div class="col-md-2 d-flex align-items-end justify-content-end">
                    <button type="submit" class="btn btn-primary" id="catat" name="submit" req> +Catat </button>
                </div>
            </form>
        </div>
